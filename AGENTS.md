...
- Key functions:
  ...
  - PDF sticker generation uses `pdf-lib` and client-side QR PNG conversion; layout is fixed to A4 12-up (70 x 68.1 mm) with a 13.5 mm top margin, 50 mm QR, top title offset 5 mm, subtitle gap 4.2 mm, bottom footer offset 6 mm, and equalized text-to-QR gaps using font metrics (src/components/qr/qr-code-list.tsx).
